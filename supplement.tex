...
%By this we mean there is a homeomorphisms from one
To construct $N$ we choose a homeomorphisms from one
...
Also, the $R-$move on the left side occurs in the exterior
