...
%We describe the theoretical framework underpinning this description and show that it is equivalent to more common representations in section \ref{secAbstract}.
...
%\cggb{i didn't understand this winding number thing so i took it out.}
...
%(from tail towards head) along a curve diagram:
\begin{center}
...
\end{center}
\cggb{Replace "measure" in this picture with "recovery".}
