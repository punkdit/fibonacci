...
To this end, we will require each such curve to intersect 
...
The words for these diagrams now read as
...
for each intersection with the tile edge, which of the four
