...
We exploit this structure to classically simulate, and thus demonstrate the success of, an error-correction protocol for a quantum memory based on a universal anyon model, the Fibonacci anyons.  We numerically simulate a phenomenological model of the system and noise processes on lattice sizes of up to 
...
information~\cite{Kitaev2003}. The topological features of such systems are insensitive to local perturbations~\cite{Bravyi2010, Bravyi2011a, Michalakis2013}, and have excitations displaying anyonic statistics~\cite{Wilczek1990}. These anyons can in general be used as quantum memories or to perform universal topological quantum computation~\cite{Freedman2002, Freedman2002b, Nayak????}.
...
its simplicity and flexibility, and the fact that its clustering scheme does is compatible with the structure in the noise processes that allows us to classically simulate them.
...
\stf{this next sentence is currently incorrect.}
The ends of curves 
