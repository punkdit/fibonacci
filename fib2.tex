...
The \dude{key?} difference between abelian and nonabelian
anyon theories is that outcomes of total charge measurements in an abelian theory
are determined uniquely by particle content only.
...
Finally, in addition to the fusion space of any anyons present, there is also a global degeneracy associated with the topology of the 
manifold on which the anyons reside. We will consider systems with the topology of a torus, 
...
%We tile the manifols with  a finite set of $L\times L$ Wilson loops arranged in
...
conditions, this space \cggb{is} the two-fold degenerate codespace. \cggb{Subtlety in that there could be anyons around in the ground space.}
