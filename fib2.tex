...
\dude{This doesn't make much sense to me:} Another potential direction is to incorporate tensor network methods for simulating anyons~\cite{Pfeifer2012, Singh2014} to improve the speed and scale of the simulations. 
...
\dude{Another important question is wether this error
correction process can be mapped to a classical stat mech problem, like RBIM.}
