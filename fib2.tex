...
\begin{center}
	{\scriptsize (i)
	\includegraphics[width=0.26\columnwidth]{pair-create.pdf}
	\hskip 5pt
	(ii)
	\includegraphics[width=0.26\columnwidth]{syndrome-1.pdf}
	\hskip 5pt
	(iii)}
	\includegraphics[width=0.26\columnwidth]{syndrome-2.pdf}
\end{center}
