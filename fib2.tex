...
% We need to relate this to discrete models: toric code, string nets, etc.
...
In the regime where the action of noise plus decoder does not percolate it is
clear that the simulation is efficient.
However at some point, with strong enough noise, the state will
