...
tau anyon is wrapped around the torus twice.
The vertical lines represent a periodic
identification, and we leave anyons paths
as undirected because Fibonacci anyons are
self-inverse.
The dotted lines represent vacuum charges,
and we are free to include these lines or
not.
\begin{align*}
...
\section{Details on the simulation algorithm}
