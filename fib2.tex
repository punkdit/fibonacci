...
labels, orientation, and base points.
...
components as well as identifying their base points.
...
the seam along which gluing occurs and so we call
...
joins two boundary components $M_1$ and $M_2$,
...
\emph{(the $2$-observable forgets the direction of the $2$-curve)}
Going the other direction...

The end points of $2$-curves are free to terminate anywhere
on the boundary component, but we can fix the endpoints using
the base points.
A simple way to do this is to just require the
$2$-curve to begin and end on base points.

By a \emph{hole} of $M$ we mean a component of $\partial M$.
