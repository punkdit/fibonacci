\documentclass[aps, letterpaper, onecolumn, superscriptaddress, notitlepage, 11pt, groupedaddress]{revtex4-1}
\usepackage{times}
...
certain quasi-particle excitations occuring in two dimensional
...
and we try to distil this down into something more manageable.
...
of particle exchange in three dimensions, whose answer is bosons and fermions.
...
the restriction of $f$ to the equator of $\StdM.$ % XXX XXX XXX \cggb{citation? or obvious?}
